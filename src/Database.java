...
public class Database {
    ...
    private final static String url = "jdbc:mysql://localhost:3306/distributed";
    private final static String user = "brian";
    private final static String password = "maclab";
